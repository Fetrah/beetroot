#ifndef BEETROOT_ROOT_FILE_HANDLER_H
#define BEETROOT_ROOT_FILE_HANDLER_H
...
namespace beetroot {
  ...
  public:      
    ...
    ROOTFileHandler( const std::string &name, const OpenAs &openType = READ );
  ...
  private:
    /** Forbid copying */
    ROOTFileHandler( const ROOTFileHandler& );
    
    /** Forbid assignment */
    void operator=( const ROOTFileHandler& );
...
#endif // BEETROOT_ROOT_FILE_HANDLER_H
